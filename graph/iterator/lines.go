...
// OrderedTemporalLines implements the graph.TemporalLines and graph.TemporalLineSlicer interfaces.
// The iteration order of OrderedTemporalLines is the order of lines passed to
// NewTemporalLineIterator.
...
// called prior to a call to TemporalLine.
...
// TemporalLineSlice returns all the remaining lines in the iterator and advances
// the iterator.
func (e *OrderedTemporalLines) TemporalLineSlice() []graph.TemporalLine {
	if e.idx >= len(e.lines) {
		return nil
	}
	idx := e.idx
